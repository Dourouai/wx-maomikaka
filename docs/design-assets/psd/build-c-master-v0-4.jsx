...
function buildCMaster() {
  doc = app.documents.add(720, 1420, 72, "C-master-v0-4-editable", NewDocumentMode.RGB, DocumentFill.TRANSPARENT);
  ...
  // v0.4: remove the plate/tag. The rarity is now a fixed, direct letter
  // sitting over the photo header, with no badge background or badge outline.
  var level = addGroup("L4A｜等级字母 C｜直接文字｜固定", l4);
  var levelShadow = addText("固定文字｜等级字母 C｜轻微阴影", "C", 80, 153, 54, "3D5241", level, "Baskerville", false);
  levelShadow.opacity = 42;
  addText("固定文字｜等级字母 C｜直接展示", "C", 77, 150, 54, "F9FDEF", level, "Baskerville", false);
  ...
  doc.saveAs(new File(baseRoot + "cat-card-c-master-v0-4-editable.psd"), options, true, Extension.LOWERCASE);
  ...
  doc.exportDocument(new File(baseRoot + "C-master-preview-v0-4-polished.png"), ExportType.SAVEFORWEB, previewOptions);
