...
function buildCMaster() {
  doc = app.documents.add(720, 1420, 72, "C-master-v0-2-editable", NewDocumentMode.RGB, DocumentFill.TRANSPARENT);
  ...
  var label = addGroup("L4A｜等级标签 C｜独立可导出", l4);
  ...
  addText("固定文字｜等级字母 C", "C", 83, 151, 64, "3D5241", label, "Baskerville", false);
  ...
  doc.saveAs(new File(baseRoot + "cat-card-c-master-v0-2-editable.psd"), options, true, Extension.LOWERCASE);
